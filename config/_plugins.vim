...
if dein#load_state('~/.cache/dein')
    ...
    call dein#add('mattn/emmet-vim') " html ninja
    call dein#add('posva/vim-vue') " vue syntax
    call dein#add('leafOfTree/vim-vue-plugin') " vue syntax
    call dein#add('neoclide/coc.nvim', {'merge':0, 'rev':'release'}) " intellsense
    ...
    " call dein#add('leafgarland/typescript-vim') " typescript highlighter
